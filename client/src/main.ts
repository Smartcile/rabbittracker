...
const icons = {
  ...
  food: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 21c0-6 3-11 14-12-1 9-5 12-10 12"/><path d="M5 21c1-4 3-6 6-8"/></svg>',
